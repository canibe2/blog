...
export const postCommentRequest = async (boardNumber : number | string, requestBody : PostCommentRequestDto, accessToken:string) => {
    ...
    .then(response => {
        const requestBody : PostCommentResponseDto = response.data;
        return requestBody;
...
export const patchBoardRequest = async (boardNumber : number | string, requestBody : PatchBoardRequestDto, accessToken : string) => {
    ...
    .then(response => {
        ...
        const requestBody : PatchBoardResponseDto = response.data;
        return requestBody;
...
export const putFavoriteRequest = async (boardNumber : number | string, accessToken : string) => {
    ...
    .then(response => {
        const requestBody : PutFavoriteResponseDto = response.data;
        return requestBody;
...
export const deleteBoardRequest = async (boardNumber : number | string, accessToken : string) => {
    ...
    .then(response => {
        const requestBody : DeleteBoardResponseDto = response.data;
        return requestBody;
...
export const fileUploadRequest = async (data : FormData) => {
    const result = await axios.post(FILE_UPLOAD_URL(),data, multipartFormData)
            .then(response => {
                const requestBody : string = response.data;
                return requestBody;
            })
            .catch(error => {
                return null;
