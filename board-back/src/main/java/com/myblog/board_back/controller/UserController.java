...
import com.myblog.board_back.dto.request.user.PatchNicknameRequestDto;
import com.myblog.board_back.dto.request.user.PatchProfileImageRequestDto;
...
import com.myblog.board_back.dto.response.user.PatchNicknameResponseDto;
import com.myblog.board_back.dto.response.user.PatchProfileImageResponseDto;
...
public class UserController {
    ...
    public ResponseEntity<? super PatchNicknameResponseDto> patchNickname(
            @RequestBody @Valid PatchNicknameRequestDto requestBody, @AuthenticationPrincipal String email) {
